...
function spt_cpt() {
	$labels = array(
		...
		'insert_into_item'      => __( 'Insert into pricing table', 'simple-pricing-table' ),
		'uploaded_to_this_item' => __( 'Uploaded to this pricing table', 'simple-pricing-table' ),
		...
		'filter_items_list'     => __( 'Filter pricing tables list', 'simple-pricing-table' ),
	);
	$args   = array(
