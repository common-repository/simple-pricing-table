...
add_action( 'admin_enqueue_scripts', 'spt_admin_scripts_styles', 100 );
/**
 * Load admin scripts and styles.
 */
function spt_admin_scripts_styles() {
	if ( get_current_screen()->id === 'simple_pricing_table' || get_current_screen()->id === 'edit-simple_pricing_table' ) {
		// Enqueue admin CSS.
		wp_enqueue_style( 'simple-pricing-table', plugin_dir_url( __DIR__ ) . 'assets/styles/admin.css' );
	}
}
